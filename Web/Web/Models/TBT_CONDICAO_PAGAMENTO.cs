...
namespace Web.Models
{
    ...
    public partial class TBT_CONDICAO_PAGAMENTO
    {
        public TBT_CONDICAO_PAGAMENTO()
        {
        ...
        public Nullable<decimal> PrazoMedio { get; set; }
        public Nullable<decimal> QtdParcela { get; set; }
        public Nullable<decimal> ValorMinimoParcela { get; set; }
